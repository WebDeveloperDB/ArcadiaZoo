...
class getNelmioApiDoc_Describers_ConfigService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['nelmio_api_doc.describers.config'] = new \Nelmio\ApiDocBundle\Describer\ExternalDocDescriber(['info' => ['title' => 'ArcadiaZoo API', 'description' => 'Documentation de l\'API ArcadiaZoo .', 'version' => '1.0.0'], 'components' => ['securitySchemes' => ['X-AUTH-TOKEN' => ['type' => 'apiKey', 'name' => 'X-AUTH-TOKEN', 'in' => 'header']]], 'security' => [['X-AUTH-TOKEN' => []]]]);
    }
}
