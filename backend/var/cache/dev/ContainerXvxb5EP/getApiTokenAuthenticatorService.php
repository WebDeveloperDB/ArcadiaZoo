...
{
    /**
     * Gets the public 'App\Security\ApiTokenAuthenticator' shared autowired service.
     *
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->services['App\\Security\\ApiTokenAuthenticator'] = new \App\Security\ApiTokenAuthenticator(($container->services['App\\Repository\\UserRepository'] ?? $container->load('getUserRepositoryService')));
    }
}
