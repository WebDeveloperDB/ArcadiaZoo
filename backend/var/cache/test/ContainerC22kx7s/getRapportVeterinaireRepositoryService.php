 ...
 */
class getRapportVeterinaireRepositoryService extends App_KernelTestDebugContainer
{
    /**
     * Gets the private 'App\Repository\RapportVeterinaireRepository' shared autowired service.
     *
     * @return \App\Repository\RapportVeterinaireRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'RapportVeterinaireRepository.php';

        return $container->privates['App\\Repository\\RapportVeterinaireRepository'] = new \App\Repository\RapportVeterinaireRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
