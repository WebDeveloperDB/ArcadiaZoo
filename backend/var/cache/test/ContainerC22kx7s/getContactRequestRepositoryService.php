 ...
 */
class getContactRequestRepositoryService extends App_KernelTestDebugContainer
{
    /**
     * Gets the private 'App\Repository\ContactRequestRepository' shared autowired service.
     *
     * @return \App\Repository\ContactRequestRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ContactRequestRepository.php';

        return $container->privates['App\\Repository\\ContactRequestRepository'] = new \App\Repository\ContactRequestRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
